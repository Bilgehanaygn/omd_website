import magicedenLogo from '../../assets/magiceden.svg';
    ...
    return (
        <div style={styles.footer} >
            ...
            </span>
            {
                ...
                null
                :
                <span href="https://twitter.com/DegenGang_NFT" target="_blank" className='footer-item' style={{display:"flex", width:225, display:"flex", justifyContent:"space-around"}} >
